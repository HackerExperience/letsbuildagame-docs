...
We will do our best to have an easy-to-install server software, but it probably will require a powerful machine (4G+ RAM, 4+ cores CPU) and Linux OS (may run on Windows/Mac with VM software).

The company sponsoring the in-house team of Hacker Experience 2, the same who created Hacker Experience 1, will offer an online hosted version of the game.